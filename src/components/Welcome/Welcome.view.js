...
class Welcome extends Component {
  ...
  render() {
    ...
    <div className="pusher">
        ...
        <div className={`ui segment vertical fixed ${css.fixed} ${css.header}`}>
            <div className="ui container center aligned vertical stripe segment">
                <div className="ui text container">
                    <h1 className="ui  header">
                    SPREAD THE LOVE
                    </h1>
                    <h4>Let's turn our world into a happier place, by sending positive energy to other people</h4>
                    <a className="ui huge primary button" href="/#/login">Get Started <i className="right arrow icon"></i></a>
                </div>
            </div>
        </div>

        <div className="ui vertical stripe quote segment" style={{marginTop: 15 + 'em'}}>
